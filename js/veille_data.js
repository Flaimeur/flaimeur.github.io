window.veilleData = `
            <div class="stage-card animate-on-scroll" style="margin-bottom: 20px; opacity: 1;">
                <div class="stage-header">
                    ...
                    <div class="stage-info">
                        <h3 class="news-title">
                            <a href="https://dev.to/rikinptl/generative-simulation-benchmarking-for-precision-oncology-clinical-workflows-with-inverse-2880" target="_blank">Analyse comparative de simulation générative pour les flux de travail cliniques de précision en oncologie avec vérification par simulation inverse</a>
                        </h3>
                        <div class="news-meta">
            ...
            <div class="stage-card animate-on-scroll" style="margin-bottom: 20px; opacity: 1;">
                <div class="stage-header">
                    ...
                    <div class="stage-info">
                        <h3 class="news-title">
                            <a href="https://dev.to/rikinptl/explainable-causal-reinforcement-learning-for-satellite-anomaly-response-operations-with-zero-trust-7l3" target="_blank">Apprentissage par renforcement causal explicable pour les opérations de réponse aux anomalies satellitaires avec des garanties de gouvernance zéro confiance</a>
                        </h3>
                        <div class="news-meta">
                            <span class="tag-quantum"><i class="fas fa-microchip"></i> Spécial Quantique</span>
                            <span class="news-date">Actualité FR</span>
            ...
            <div class="stage-card animate-on-scroll" style="margin-bottom: 20px; opacity: 1;">
                <div class="stage-header">
                    ...
                    <div class="stage-info">
                        <h3 class="news-title">
                            <a href="https://dev.to/rikinptl/edge-to-cloud-swarm-coordination-for-planetary-geology-survey-missions-under-real-time-policy-l2n" target="_blank">Coordination d'essaims de la périphérie au cloud pour les missions d'étude géologique planétaire sous contraintes politiques en temps réel</a>
                        </h3>
                        <div class="news-meta">
                            <span class="tag-quantum"><i class="fas fa-microchip"></i> Spécial Quantique</span>
                            <span class="news-date">Actualité FR</span>
            ...
            <div class="stage-card animate-on-scroll" style="margin-bottom: 20px; opacity: 1;">
                <div class="stage-header">
                    ...
                    <div class="stage-info">
                        <h3 class="news-title">
                            <a href="https://dev.to/rikinptl/adaptive-neuro-symbolic-planning-for-deep-sea-exploration-habitat-design-across-multilingual-1bdl" target="_blank">Planification neuro-symbolique adaptative pour la conception d'habitats d'exploration en haute mer au sein de groupes de parties prenantes multilingues</a>
                        </h3>
                        <div class="news-meta">
                            <span class="tag-quantum"><i class="fas fa-microchip"></i> Spécial Quantique</span>
                            <span class="news-date">Actualité FR</span>
