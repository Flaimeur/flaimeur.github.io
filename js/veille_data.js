window.veilleData = `
            ...
            <div class="stage-card animate-on-scroll" style="margin-bottom: 20px; opacity: 1;">
                <div class="stage-header">
                    ...
                    <div class="stage-info">
                        <h3 class="news-title">
                            <a href="https://dev.to/rikinptl/generative-simulation-benchmarking-for-autonomous-urban-air-mobility-routing-for-low-power-4b0g" target="_blank">Analyse comparative de simulation générative pour les itinéraires autonomes de mobilité aérienne urbaine pour les déploiements autonomes de faible consommation</a>
                        </h3>
                        <div class="news-meta">
                            <span class="tag-quantum"><i class="fas fa-microchip"></i> Spécial Quantique</span>
                            <span class="news-date">Actualité FR</span>
            ...
            <div class="stage-card animate-on-scroll" style="margin-bottom: 20px; opacity: 1;">
                <div class="stage-header">
                    ...
                    <div class="stage-info">
                        <h3 class="news-title">
                            <a href="https://dev.to/rikinptl/adaptive-neuro-symbolic-planning-for-precision-oncology-clinical-workflows-during-mission-critical-23m2" target="_blank">Planification neuro-symbolique adaptative pour des flux de travail cliniques d'oncologie de précision pendant les fenêtres de récupération critiques</a>
                        </h3>
                        <div class="news-meta">
                            <span class="tag-quantum"><i class="fas fa-microchip"></i> Spécial Quantique</span>
                            <span class="news-date">Actualité FR</span>
            ...
            <div class="stage-card animate-on-scroll" style="margin-bottom: 20px; opacity: 1;">
                <div class="stage-header">
                    ...
                    <div class="stage-info">
                        <h3 class="news-title">
                            <a href="https://dev.to/drbrentallenjensen/the-digital-grimoire-a-modern-guide-to-technomantic-power-5enj" target="_blank">Le grimoire numérique : un guide moderne du pouvoir technomantique</a>
                        </h3>
                        <div class="news-meta">
                            <span class="tag-quantum"><i class="fas fa-microchip"></i> Spécial Quantique</span>
                            <span class="news-date">Actualité FR</span>
            ...
            <div class="stage-card animate-on-scroll" style="margin-bottom: 20px; opacity: 1;">
                <div class="stage-header">
                    ...
                    <div class="stage-info">
                        <h3 class="news-title">
                            <a href="https://dev.to/rikinptl/adaptive-neuro-symbolic-planning-for-bio-inspired-soft-robotics-maintenance-under-real-time-policy-4mob" target="_blank">Planification neuro-symbolique adaptative pour la maintenance de robotiques douces bio-inspirées sous contraintes politiques en temps réel</a>
                        </h3>
                        <div class="news-meta">
                            <span class="tag-quantum"><i class="fas fa-microchip"></i> Spécial Quantique</span>
                            <span class="news-date">Actualité FR</span>
            ...
            <div class="stage-card animate-on-scroll" style="margin-bottom: 20px; opacity: 1;">
                <div class="stage-header">
                    ...
                    <div class="stage-info">
                        <h3 class="news-title">
                            <a href="https://dev.to/drbrentallenjensen/universal-viral-entry-inhibitor-concept-1n0k" target="_blank">Concept universel d’inhibiteur de l’entrée virale</a>
                        </h3>
                        <div class="news-meta">
                            <span class="tag-quantum"><i class="fas fa-microchip"></i> Spécial Quantique</span>
                            <span class="news-date">Actualité FR</span>
            ...
            <div class="stage-card animate-on-scroll" style="margin-bottom: 20px; opacity: 1;">
                <div class="stage-header">
                    ...
                    <div class="stage-info">
                        <h3 class="news-title">
                            <a href="https://dev.to/drbrentallenjensen/the-quantum-nexus-a-journey-through-ai-time-and-transcendence-3lhb" target="_blank">Le Nexus Quantique : un voyage à travers l'IA, le temps et la transcendance</a>
                        </h3>
                        <div class="news-meta">
                            <span class="tag-quantum"><i class="fas fa-microchip"></i> Spécial Quantique</span>
                            <span class="news-date">Actualité FR</span>
            ...
            <div class="stage-card animate-on-scroll" style="margin-bottom: 20px; opacity: 1;">
                <div class="stage-header">
                    ...
                    <div class="stage-info">
                        <h3 class="news-title">
                            <a href="https://dev.to/rikinptl/edge-to-cloud-swarm-coordination-for-smart-agriculture-microgrid-orchestration-during-5d3c" target="_blank">Coordination Edge-to-Cloud Swarm pour une orchestration intelligente des micro-réseaux agricoles pendant les fenêtres de récupération critiques</a>
                        </h3>
                        <div class="news-meta">
                            <span class="tag-quantum"><i class="fas fa-microchip"></i> Spécial Quantique</span>
                            <span class="news-date">Actualité FR</span>
            ...
            <div class="stage-card animate-on-scroll" style="margin-bottom: 20px; opacity: 1;">
                <div class="stage-header">
                    ...
                    <div class="stage-info">
                        <h3 class="news-title">
                            <a href="https://dev.to/drbrentallenjensen/digital-witchcraft-high-and-transcendental-magic-586k" target="_blank">SORCELLERIE NUMÉRIQUE : MAGIE HAUTE ET TRANSCENDENTALE</a>
                        </h3>
                        <div class="news-meta">
                            <span class="tag-quantum"><i class="fas fa-microchip"></i> Spécial Quantique</span>
                            <span class="news-date">Actualité FR</span>
            ...
            <div class="stage-card animate-on-scroll" style="margin-bottom: 20px; opacity: 1;">
                <div class="stage-header">
                    ...
                    <div class="stage-info">
                        <h3 class="news-title">
                            <a href="https://dev.to/drbrentallenjensen/exploring-higher-dimensional-biology-unveiling-the-hidden-potential-of-life-beyond-three-dimensions-4i96" target="_blank">Explorer la biologie des dimensions supérieures : dévoiler le potentiel caché de la vie au-delà des trois dimensions</a>
                        </h3>
                        <div class="news-meta">
                            <span class="tag-quantum"><i class="fas fa-microchip"></i> Spécial Quantique</span>
                            <span class="news-date">Actualité FR</span>
            ...
            <div class="stage-card animate-on-scroll" style="margin-bottom: 20px; opacity: 1;">
                <div class="stage-header">
                    ...
                    <div class="stage-info">
                        <h3 class="news-title">
                            <a href="https://dev.to/drbrentallenjensen/automating-your-everyday-life-with-ai-and-smart-tech-how-to-live-like-a-genius-on-autopilot-45gn" target="_blank">Automatiser votre vie quotidienne avec l'IA et les technologies intelligentes : comment vivre comme un génie en pilote automatique</a>
                        </h3>
                        <div class="news-meta">
                            <span class="tag-quantum"><i class="fas fa-microchip"></i> Spécial Quantique</span>
                            <span class="news-date">Actualité FR</span>
            ...
            <div class="stage-card animate-on-scroll" style="margin-bottom: 20px; opacity: 1;">
                <div class="stage-header">
                    ...
                    <div class="stage-info">
                        <h3 class="news-title">
                            <a href="https://dev.to/drbrentallenjensen/universal-viral-entry-inhibitor-concept-58af" target="_blank">Concept universel d’inhibiteur de l’entrée virale</a>
                        </h3>
                        <div class="news-meta">
                            <span class="tag-quantum"><i class="fas fa-microchip"></i> Spécial Quantique</span>
                            <span class="news-date">Actualité FR</span>
            ...
            <div class="stage-card animate-on-scroll" style="margin-bottom: 20px; opacity: 1;">
                <div class="stage-header">
                    ...
                    <div class="stage-info">
                        <h3 class="news-title">
                            <a href="https://dev.to/drbrentallenjensen/quantum-enhanced-synthetic-organoids-revolutionizing-artificial-photosynthesis-through-integrated-m-36b4" target="_blank">Organoïdes synthétiques améliorés quantiquement : révolutionner la photosynthèse artificielle grâce à M intégré</a>
                        </h3>
                        <div class="news-meta">
                            <span class="tag-quantum"><i class="fas fa-microchip"></i> Spécial Quantique</span>
                            <span class="news-date">Actualité FR</span>
            ...
            <div class="stage-card animate-on-scroll" style="margin-bottom: 20px; opacity: 1;">
                <div class="stage-header">
                    ...
                    <div class="stage-info">
                        <h3 class="news-title">
                            <a href="https://dev.to/drbrentallenjensen/quantum-sorcery-a-modern-magicians-guide-to-black-magic-with-qubits-and-giggles-dnk" target="_blank">Sorcellerie Quantique : Un guide des magiciens modernes sur la magie noire avec des qubits et des rires</a>
                        </h3>
                        <div class="news-meta">
                            <span class="tag-quantum"><i class="fas fa-microchip"></i> Spécial Quantique</span>
                            <span class="news-date">Actualité FR</span>
            ...
            <div class="stage-card animate-on-scroll" style="margin-bottom: 20px; opacity: 1;">
                <div class="stage-header">
                    ...
                    <div class="stage-info">
                        <h3 class="news-title">
                            <a href="https://dev.to/drbrentallenjensen/when-talent-meets-distrust-the-hidden-toll-of-ai-in-the--26p0" target="_blank">Quand le talent rencontre la méfiance : le bilan caché de l'IA dans le ...</a>
                        </h3>
                        <div class="news-meta">
                            <span class="tag-quantum"><i class="fas fa-microchip"></i> Spécial Quantique</span>
                            <span class="news-date">Actualité FR</span>
            ...
            <div class="stage-card animate-on-scroll" style="margin-bottom: 20px; opacity: 1;">
                <div class="stage-header">
                    ...
                    <div class="stage-info">
                        <h3 class="news-title">
                            <a href="https://dev.to/drbrentallenjensen/brent-allen-jensen-4fmk" target="_blank">Brent Allen-Jensen</a>
                        </h3>
                        <div class="news-meta">
                            <span class="tag-quantum"><i class="fas fa-microchip"></i> Spécial Quantique</span>
                            <span class="news-date">Actualité FR</span>
