window.veilleData = `
            ...
            <div class="stage-card animate-on-scroll" style="margin-bottom: 20px; opacity: 1;">
                <div class="stage-header">
                    ...
                    <div class="stage-info">
                        <h3 class="news-title">
                            <a href="https://dev.to/rikinptl/probabilistic-graph-neural-inference-for-sustainable-aquaculture-monitoring-systems-across-446j" target="_blank">Inférence neuronale graphique probabiliste pour les systèmes de surveillance de l'aquaculture durable au sein de groupes de parties prenantes multilingues</a>
                        </h3>
                        <div class="news-meta">
                            <span class="tag-quantum"><i class="fas fa-microchip"></i> Spécial Quantique</span>
                            <span class="news-date">Actualité FR</span>
            ...
            <div class="stage-card animate-on-scroll" style="margin-bottom: 20px; opacity: 1;">
                <div class="stage-header">
                    ...
                    <div class="stage-info">
                        <h3 class="news-title">
                            <a href="https://dev.to/rikinptl/probabilistic-graph-neural-inference-for-coastal-climate-resilience-planning-with-inverse-27ek" target="_blank">Inférence neuronale graphique probabiliste pour la planification de la résilience climatique côtière avec vérification par simulation inverse</a>
                        </h3>
                        <div class="news-meta">
                            <span class="tag-quantum"><i class="fas fa-microchip"></i> Spécial Quantique</span>
                            <span class="news-date">Actualité FR</span>
            ...
            <div class="stage-card animate-on-scroll" style="margin-bottom: 20px; opacity: 1;">
                <div class="stage-header">
                    ...
                    <div class="stage-info">
                        <h3 class="news-title">
                            <a href="https://dev.to/iaexplore/deep-dive-quantum-computing-what-it-is-how-it-works-and-how-it-will-change-your-life-7ii" target="_blank">Approfondissement : L'informatique quantique : qu'est-ce que c'est, comment ça marche et comment cela va changer votre vie</a>
                        </h3>
                        <div class="news-meta">
                            <span class="tag-quantum"><i class="fas fa-microchip"></i> Spécial Quantique</span>
                            <span class="news-date">Actualité FR</span>
            ...
            <div class="stage-card animate-on-scroll" style="margin-bottom: 20px; opacity: 1;">
                <div class="stage-header">
                    ...
                    <div class="stage-info">
                        <h3 class="news-title">
                            <a href="https://dev.to/rikinptl/sparse-federated-representation-learning-for-bio-inspired-soft-robotics-maintenance-across-366j" target="_blank">Apprentissage par représentation fédérée éparse pour la maintenance robotique douce bio-inspirée au sein de groupes de parties prenantes multilingues</a>
                        </h3>
                        <div class="news-meta">
                            <span class="tag-quantum"><i class="fas fa-microchip"></i> Spécial Quantique</span>
                            <span class="news-date">Actualité FR</span>
            ...
            <div class="stage-card animate-on-scroll" style="margin-bottom: 20px; opacity: 1;">
                <div class="stage-header">
                    ...
                    <div class="stage-info">
                        <h3 class="news-title">
                            <a href="https://dev.to/rikinptl/meta-optimized-continual-adaptation-for-precision-oncology-clinical-workflows-under-real-time-5565" target="_blank">Adaptation continue méta-optimisée pour les flux de travail cliniques d'oncologie de précision sous contraintes politiques en temps réel</a>
                        </h3>
                        <div class="news-meta">
                            <span class="tag-quantum"><i class="fas fa-microchip"></i> Spécial Quantique</span>
                            <span class="news-date">Actualité FR</span>
